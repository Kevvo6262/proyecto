        ...
        buttonApply.setOnClickListener ( new View.OnClickListener ( ) {
            ...
            public void onClick(View v) {
                ...
                if( r1.isChecked() ==true ){
                    ...
                    if(pos==0)  Toast.makeText(getApplicationContext(), "Gracias Jorge torres por tu voto", Toast.LENGTH_SHORT).show();
                    if(pos==1)  Toast.makeText(getApplicationContext(), "Gracias Lisseth mcdonald por tu voto", Toast.LENGTH_SHORT).show();
                    if(pos==2)  Toast.makeText(getApplicationContext(), "Gracias Kevin Coronado por tu voto", Toast.LENGTH_SHORT).show();
                    if(pos==3)  Toast.makeText(getApplicationContext(), "Gracias Marlina Sanchez por tu voto", Toast.LENGTH_SHORT).show();
                    if(pos==4)  Toast.makeText(getApplicationContext(), "Gracias Eddie Bustamante por tu voto", Toast.LENGTH_SHORT).show();
                    vt = 1;
                }
